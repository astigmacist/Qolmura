...
class SeedCatalogCommandTests(TestCase):
    def test_redeploy_seed_does_not_overwrite_admin_changes(self):
        ...
        self.assertEqual(Artisan.objects.count(), 16)
        ...
        carpet = Product.objects.get(slug="asqaq-barys-carpet")
        self.assertEqual(carpet.artisan.shop_name, "Ж. Шораев")
        self.assertEqual(carpet.dimensions_kk, "1,80 × 1,20 м")
