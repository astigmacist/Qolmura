...
const content = {
  kk: {
    ...
    a2: "Каталогта Астана және Париж көрмелерінің 77 нақты бұйымы бар. Жаңа шеберлер туралы жаңалықтар @qolmura.kz парақшасында жарияланады.",
  ...
  ru: {
    ...
    a2: "В каталоге уже представлены 77 реальных работ из коллекций выставок в Астане и Париже. Новости о новых мастерах публикуются на странице @qolmura.kz.",
